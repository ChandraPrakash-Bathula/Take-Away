            ...
            <div>
                {this.props.selectedItems && this.props.selectedItems.length > 0 && (
                    <div className="cart-container">
                        ...
                        <button style={{color: "black",background : "skyblue", fontSize: 18}} onClick={e => this.checkout()}>CHECKOUT</button>
                    </div>
                )}
                {this.state.checkoutAlert && (
                    <div className="cart-container">
                        <div style={{color: "slategray", fontSize: 18}}className="success">
                            {"Your order is on it's way and will be delivered in 30 minutes."}
                        </div>
                        <button style={{color: "black",background : "skyblue", fontSize: 18}} onClick={e => this.setState({
                            checkoutAlert: false
